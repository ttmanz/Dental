...
async function seed() {
  ...
  const apptDefs = [
    ...
    { daysOff:-13, time:'11:00', dur:90,  type:'treatment',     status:'completed', dentist:0, patient:2 },
    { daysOff:-12, time:'09:30', dur:45,  type:'treatment',     status:'completed', dentist:2, patient:3 },
    { daysOff:-11, time:'14:00', dur:30,  type:'consultation',  status:'completed', dentist:1, patient:4 },
    { daysOff:-10, time:'10:00', dur:60,  type:'emergency',     status:'completed', dentist:0, patient:5 },
    { daysOff: -9, time:'11:30', dur:30,  type:'consultation',  status:'completed', dentist:2, patient:6 },
    { daysOff: -7, time:'09:00', dur:90,  type:'treatment',     status:'completed', dentist:0, patient:7 },
    { daysOff: -6, time:'15:00', dur:30,  type:'consultation',  status:'completed', dentist:1, patient:8 },
    { daysOff: -5, time:'10:00', dur:45,  type:'treatment',     status:'completed', dentist:2, patient:9 },
    { daysOff: -3, time:'09:30', dur:30,  type:'cleaning',      status:'completed', dentist:0, patient:10 },
    { daysOff: -2, time:'14:30', dur:60,  type:'treatment',     status:'completed', dentist:1, patient:11 },
    ...
    { daysOff:  0, time:'10:30', dur:45,  type:'treatment',     status:'confirmed', dentist:1, patient:2 },
    { daysOff:  0, time:'12:00', dur:30,  type:'consultation',  status:'scheduled', dentist:2, patient:3 },
    { daysOff:  0, time:'14:00', dur:90,  type:'treatment',     status:'scheduled', dentist:0, patient:4 },
    { daysOff:  0, time:'16:00', dur:30,  type:'consultation',  status:'scheduled', dentist:1, patient:5 },
    // Future
    { daysOff:  1, time:'09:30', dur:60,  type:'treatment',     status:'scheduled', dentist:0, patient:6 },
    { daysOff:  1, time:'11:00', dur:30,  type:'consultation',  status:'scheduled', dentist:2, patient:7 },
    { daysOff:  2, time:'10:00', dur:45,  type:'treatment',     status:'scheduled', dentist:1, patient:8 },
    { daysOff:  3, time:'09:00', dur:60,  type:'cleaning',      status:'scheduled', dentist:0, patient:9 },
    { daysOff:  4, time:'14:30', dur:90,  type:'treatment',     status:'scheduled', dentist:2, patient:10 },
    ...
    { daysOff: 10, time:'11:00', dur:45,  type:'treatment',     status:'scheduled', dentist:2, patient:1 },
    { daysOff: 14, time:'14:00', dur:30,  type:'consultation',  status:'scheduled', dentist:1, patient:2 },
  ]
